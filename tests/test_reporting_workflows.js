...
A.ok('populated sheets present, empty Changes omitted', ['Summary', 'Competitors', 'Offers_Prices', 'Evidence', 'Run_Metadata'].every(n => e1.exp.json.xlsx_sheets.indexOf(n) >= 0) && e1.exp.json.xlsx_sheets.indexOf('Changes') < 0);
