...
1. **REPORT-TRUTH B/C/D (§4–§7)**: evidence-grounded claim validation (no market-wide claims from one homepage); semantic quality guards; **concise Telegram renderer** (700–1200 / 300–700 / 250–600, hard max 1500 — current live report is ~10k chars in 3 chunks); XLSX truth (current-request scope, no global inventory totals, dedup, evidenced regions).
