...
**Статус (итог сессии 75).** Все WIP закрыты и **смёржены в `main`** (merge-коммит `8c1bd94`, PR #49) после
зелёного CI `offline-regression` (и на ветке, и на `main` — первый зелёный `main` после красной серии #46–#48).
